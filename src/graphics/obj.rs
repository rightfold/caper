...
impl<P, N> Obj<P, N> where P: From<Vector3<f32>>, N: From<Vector3<f32>> {
    pub fn new(raw_vertex_positions: &[RawVertexPosition],
               raw_vertex_normals: &[RawVertexNormal],
               raw_faces: &[RawFace]) -> Result<Self, Error> {
        ...
        Ok(Obj{vertex_positions, vertex_normals, vertex_indices})
    }
    ...
    pub fn read(source: &str) -> Result<Self, Error> {
        ...
        Self::new(&raw_vertex_positions, &raw_vertex_normals, &raw_faces)
    }
